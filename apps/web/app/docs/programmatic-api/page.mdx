...
<table>
  ...
  <tbody>
    ...
    <tr><td><code>@emulators/google</code></td><td>Google OAuth, Gmail, Calendar, Drive, Docs, Sheets, Slides</td></tr>
    <tr><td><code>@emulators/slack</code></td><td>Slack Web API, message search, OAuth v2, webhooks</td></tr>
