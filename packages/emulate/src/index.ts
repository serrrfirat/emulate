...
Workspace APIs:
  GitHub includes contents, commit statuses, pull request review threads, and seeded Actions runs.
  Google includes Gmail, Calendar event updates, Drive sharing and shared drives, Docs, Sheets, and Slides.
